...
<td><a href="DeleteProduct?id={{p1.prod_id}}">Delete</a></td>
<td><a href="UpdateProduct?id={{p1.prod_id}}">Edit</a></td>
<td><a href="<c:url value='pupdate${product.prod_id}' />">Edit</a></td>
       </tr>
   </tbody>
     </table>
  <h3 style="font-color:red;"><a href="addProducts">Back</a></h3>
</div>
